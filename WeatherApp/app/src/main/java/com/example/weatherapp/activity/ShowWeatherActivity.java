...
import com.example.weatherapp.databinding.ActivityShowWeatherBinding;
...
public class ShowWeatherActivity extends WeatherHandlingActivity<ShowWeatherViewModel, ActivityShowWeatherBinding> {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setTitle(cityName.isEmpty() ? getString(R.string.no_result_found) : getString(R.string.weather_in, cityName));
